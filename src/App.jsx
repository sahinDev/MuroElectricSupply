	...
	return (
		<div className="min-h-screen overflow-x-hidden bg-slate-50 text-slate-950">
			<header className="sticky top-0 z-40 border-b bg-white/95 backdrop-blur">
				<div className="relative mx-auto flex w-full max-w-6xl items-center justify-center gap-3 px-4 py-3 sm:px-6 md:justify-between lg:px-8">
					...
					<div className="hidden md:flex md:flex-1 md:items-center md:justify-center md:gap-4">
					...
					<button
						...
						className="fixed left-4 top-3 z-50 inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-blue-700 bg-blue-600 text-white shadow-sm sm:left-6 md:hidden"
					>
			...
			<main className="mx-auto w-full max-w-6xl px-4 pb-24 sm:px-6 lg:px-8">
				<section className="relative w-full overflow-hidden bg-slate-950 px-4 py-8 text-white sm:px-6 lg:px-10">
					...
					<div className="relative z-10">
						<div>
							<div className="mb-4 flex min-w-0 items-center gap-3 rounded-3xl bg-white/10 px-4 py-3 ring-1 ring-white/20">
